...
def main(argv):
    try: 
        ...
        for pkt in pcap_pkts:            
            ...
            one_full_packet = {"protocolstack": ' '.join(layerlist), "data" : []}
            ...
            for layer in layerlist[1::]:
                try:
                    ...
                    layerstore_by_proto.setdefault(layer,[]).append(pkt[layer].fields.values())
                    # also add this information to the full packet representation
                    one_full_packet["data"].append(pkt[layer].fields.values())
                    ...
                    if pkt.haslayer(detaillayer):
                        ...
                        one_full_packet["data"].append(pkt[detaillayer].fields.values())
